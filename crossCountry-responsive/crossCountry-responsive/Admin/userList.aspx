...
<asp:hyperlinkField DataTextField="Name" HeaderText="Name" DataNavigateUrlFields="users_id" DataNavigateUrlFormatString="/Admin/modifyUser.aspx?userId={0}"  SortExpression="Name" HeaderStyle-CssClass="visible-lg visible-md visible-sm visible-xs" ItemStyle-CssClass="visible-lg visible-md visible-sm visible-xs"/> 
