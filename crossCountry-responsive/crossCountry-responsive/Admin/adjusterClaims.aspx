<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="adjusterClaims.aspx.vb" Inherits="crossCountry_responsive.adjusterClaims" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

<div class="panel panel-default">

<div class="container">
<h4 class="lead"> <strong>Assigned Claims: </strong> <asp:Label ID="lblHeader" runat="server" Text=""></asp:Label></h4>
</div>
